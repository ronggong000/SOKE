...
from mymodel.vae_2.vqvae_not_option_fixed_length import arg_parse
from mymodel.vae_2.vqvae_not_trainer_rod3_fixed_length import VQVAETrainer
...
def _import_data_module(name: str):
    ...
    # 2) short-name import from SOKE/mGPT/data
