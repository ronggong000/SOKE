...
#SBATCH --output=test_new_vaes_output.txt
#SBATCH --error=test_new_vaes_error.txt
...
nvidia-smi
python -u test_my_vae.py --checkpoint_name best --split test --progress_every 1
