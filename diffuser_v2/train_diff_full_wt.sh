#!/bin/bash
#SBATCH --job-name=diff_asl_full_wt  # Job的名称
...
#SBATCH --output=diff_asl_full_wt_output.txt

# Set the file for error log (stderr)
#SBATCH --error=diff_asl_full_wt_error.txt
...
python train_denoiser_v2.py \
    ...
    --enable_custom_weight \
    --custom_weight_dir /home/smuk0019/ar85_scratch2/singyu/aslcitizen/experiments_with_vel_arg/softweight_time_only/tcn_tpp__both/gradcam \
    --custom_weight_key soft_w \
    --custom_weight_precheck \
