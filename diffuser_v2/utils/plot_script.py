...
# ----New function for plotting 3D animation based on attention weights----
def plot_3d_motion_attn(save_path, kinematic_tree, joints, title, attn, figsize=(10, 10), fps=120, radius=4):
    ...
    attn = attn.reshape(len(attn), -1) # (seq_len, num_body_parts)
    ...
    if kinematic_tree == paramUtil.t2m_kinematic_chain: # t2m
