#!/bin/bash
#SBATCH --job-name=diff_h2s_rag_on  # Job的名称
...
#SBATCH --output=diff_h2s_rag_on_output.txt

# Set the file for error log (stderr)
#SBATCH --error=diff_h2s_rag_on_error.txt
...
python train_denoiser_v2_how2sign.py \
    --name h2s_v2_lenpos_rag_on_cached_bf16 \
