#!/bin/bash
#SBATCH --job-name=diff_h2s_vae12_rag_on
#SBATCH --account=ar85
#SBATCH --qos=fitq
#SBATCH --nodes=1
...
#SBATCH --output=diff_h2s_vae12_rag_on_output.txt
#SBATCH --error=diff_h2s_vae12_rag_on_error.txt
...
python train_denoiser_v2_how2sign_vae12.py \
    --name h2s_vae12_lenpos_rag_on_cached_bf16 \
